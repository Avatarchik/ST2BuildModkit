...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x03DF7170
	 * 		Name   -> Function AssetRegistry.AssetRegistryHelpers.SortAssetData
	 ...
	 */
	void UAssetRegistryHelpers::STATIC_SortAssetData(TArray<struct FAssetData> InAssetData, TArray<struct FAssetData>* OutAssetData)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AssetRegistry.AssetRegistryHelpers.SortAssetData");
		
		UAssetRegistryHelpers_SortAssetData_Params params {};
		params.InAssetData = InAssetData;
	 ...
	 * Function:
	 * 		RVA    -> 0x03DF58D0
	 * 		Name   -> Function AssetRegistry.AssetRegistryHelpers.GetShortName
	 * 		Flags  -> (Final, Native, Static, Public, HasOutParms, HasDefaults, BlueprintCallable, BlueprintPure)
	 * Parameters:
	 * 		struct FAssetData                                  InAssetData                                                (ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	class FString UAssetRegistryHelpers::STATIC_GetShortName(const struct FAssetData& InAssetData)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AssetRegistry.AssetRegistryHelpers.GetShortName");
		
		UAssetRegistryHelpers_GetShortName_Params params {};
		params.InAssetData = InAssetData;
