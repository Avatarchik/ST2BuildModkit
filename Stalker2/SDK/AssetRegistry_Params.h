...
namespace CG
{
	...
	/**
	 * Function AssetRegistry.AssetRegistryHelpers.SortAssetData
	 */
	struct UAssetRegistryHelpers_SortAssetData_Params
	{
	public:
		TArray<struct FAssetData>                                  InAssetData;                                             // 0x0000(0x0010)  (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	...
	{
	public:
		struct FARFilter                                           InFilter;                                                // 0x0000(0x0100)  (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
		TArray<struct FTagAndValue>                                InTagsAndValues;                                         // 0x0100(0x0010)  (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
		struct FARFilter                                           ReturnValue;                                             // 0x0110(0x0100)  (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
	};
	...
	/**
	 * Function AssetRegistry.AssetRegistryHelpers.GetShortName
	 */
	struct UAssetRegistryHelpers_GetShortName_Params
	{
	public:
		struct FAssetData                                          InAssetData;                                             // 0x0000(0x0060)  (ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	public:
		...
		unsigned char                                              UnknownData_9U9R[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		struct FARFilter                                           Filter;                                                  // 0x0010(0x0100)  (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_FP0V[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_S2VQ[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	{
	public:
		struct FARFilter                                           Filter;                                                  // 0x0000(0x0100)  (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
		TArray<struct FAssetData>                                  OutAssetData;                                            // 0x0100(0x0010)  (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
	...
	public:
		...
		unsigned char                                              UnknownData_1UZQ[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FAssetData                                          ReturnValue;                                             // 0x0010(0x0060)  (Parm, OutParm, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	};
