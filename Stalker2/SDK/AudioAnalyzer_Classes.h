...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_F7OB[0x44];                                  // 0x0034(0x0044) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2M2V[0x8];                                   // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BIE1[0x50];                                  // 0x0040(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_W4DI[0x10];                                  // 0x0040(0x0010) MISSED OFFSET (PADDING)
