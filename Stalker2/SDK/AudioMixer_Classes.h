...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_KSV4[0x3];                                   // 0x02B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1XN4[0x3];                                   // 0x02B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MDYV[0x3];                                   // 0x0729(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ROXF[0x4];                                   // 0x0734(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2BS2[0x20];                                  // 0x0748(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MZVP[0x28];                                  // 0x0778(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_B50S[0x80];                                  // 0x0028(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_JHHC[0x8];                                   // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_P2AU[0x18];                                  // 0x0048(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TYLQ[0x18];                                  // 0x0070(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_OICA[0x18];                                  // 0x0098(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_M4S6[0x18];                                  // 0x00C0(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NZEE[0x18];                                  // 0x00E8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HU4U[0x18];                                  // 0x0110(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WWIC[0x198];                                 // 0x0028(0x0198) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_73LE[0x88];                                  // 0x0068(0x0088) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_OGPA[0x38];                                  // 0x0068(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_TN8Y[0x68];                                  // 0x0068(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_UVUL[0x110];                                 // 0x0040(0x0110) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_UI5X[0x18];                                  // 0x0398(0x0018) MISSED OFFSET (PADDING)
