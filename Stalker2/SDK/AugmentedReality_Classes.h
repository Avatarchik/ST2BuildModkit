...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_OU0F[0x20];                                  // 0x0030(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_G5QO[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0050(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFailed;                                                // 0x0060(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_JJYJ[0x40];                                  // 0x0070(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_IQMY[0x30];                                  // 0x02C0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8I1N[0x7];                                   // 0x02F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_K0L3[0x18];                                  // 0x0318(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_PYKJ[0xF];                                   // 0x0331(0x000F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2R39[0x5];                                   // 0x0333(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_O02O[0x28];                                  // 0x0398(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0050(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFailed;                                                // 0x0060(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_RQQY[0x30];                                  // 0x0070(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0050(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFailed;                                                // 0x0060(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_KFFO[0x38];                                  // 0x0070(0x0038) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ELPC[0x10];                                  // 0x02D0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_Q9N3[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Z1UC[0x1F];                                  // 0x0101(0x001F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_M0D3[0x10];                                  // 0x0140(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9OGR[0x2];                                   // 0x0046(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0EQ7[0x3];                                   // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KS5Y[0x1];                                   // 0x008F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JU91[0x4];                                   // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MTTI[0x6];                                   // 0x00AA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_O241[0x64];                                  // 0x036C(0x0064) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_WR5J[0x8];                                   // 0x0320(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NPOJ[0x8];                                   // 0x07F0(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		class UAREnvironmentCaptureProbe*                          CaptureProbe;                                            // 0x0290(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_WFNY[0x8];                                   // 0x0298(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9V96[0x3];                                   // 0x01F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LQEY[0x8];                                   // 0x0218(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_B0GO[0x3];                                   // 0x0291(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3H3N[0x8];                                   // 0x02B8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_6V5R[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0K7O[0xF];                                   // 0x0101(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DCKD[0x16];                                  // 0x011A(0x0016) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6ZC6[0xC];                                   // 0x0134(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_OIF4[0x10];                                  // 0x0148(0x0010) Fix size for supers
	...
	{
	public:
		unsigned char                                              UnknownData_JTT7[0x8];                                   // 0x0158(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_KZLR[0x8];                                   // 0x01A8(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_QFZ7[0x8];                                   // 0x0158(0x0008) Fix Super Size
	...
	public:
		...
		unsigned char                                              UnknownData_O62J[0xC];                                   // 0x0184(0x000C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_86XT[0x7];                                   // 0x0171(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<EARFaceBlendShape, float>                             BlendShapes;                                             // 0x0178(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_0CW1[0x38];                                  // 0x01C8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_0PGE[0x8];                                   // 0x0178(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VIBF[0x8];                                   // 0x01A8(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_E2C4[0x8];                                   // 0x0158(0x0008) Fix Super Size
	...
	{
	public:
		unsigned char                                              UnknownData_9M4O[0x8];                                   // 0x0158(0x0008) Fix Super Size
		unsigned char                                              UnknownData_DOPR[0x10];                                  // 0x0160(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GUTG[0x7];                                   // 0x0051(0x0007) MISSED OFFSET (PADDING)
