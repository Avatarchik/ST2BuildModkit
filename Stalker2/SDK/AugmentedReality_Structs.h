...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_JVZ7[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_UBX7[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_B216[0xF];                                   // 0x00C1(0x000F) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_8YXW[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	public:
		struct FARSessionPayload                                   SessionPayload;                                          // 0x0000(0x0018) BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_9NPB[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FDJR[0x8];                                   // 0x0098(0x0008) MISSED OFFSET (PADDING)
	};
	...
	public:
		struct FARSessionPayload                                   SessionPayload;                                          // 0x0000(0x0018) BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_6HV5[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FTransform                                          WorldTransform;                                          // 0x0020(0x0060) BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_JXJ2[0x8];                                   // 0x00A8(0x0008) MISSED OFFSET (PADDING)
	};
	...
	public:
		struct FARSessionPayload                                   SessionPayload;                                          // 0x0000(0x0018) BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_N4W4[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FTransform                                          WorldTransform;                                          // 0x0020(0x0060) BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_KH1U[0xF];                                   // 0x0081(0x000F) MISSED OFFSET (PADDING)
	};
	...
	public:
		struct FARSessionPayload                                   SessionPayload;                                          // 0x0000(0x0018) BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_JCY1[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FTransform                                          WorldTransform;                                          // 0x0020(0x0060) BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_OHVJ[0x3];                                   // 0x008D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_T3RZ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_CRYL[0x7];                                   // 0x0049(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_OQEJ[0xB];                                   // 0x0005(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BHAN[0x18];                                  // 0x0078(0x0018) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_K3N1[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (PADDING)
	};
