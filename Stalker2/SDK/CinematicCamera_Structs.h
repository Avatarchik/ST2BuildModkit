...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_80FV[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0FMY[0x18];                                  // 0x0008(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LVX5[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_PR25[0x7];                                   // 0x0041(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_X9EO[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KW0I[0x3];                                   // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VOJX[0x3];                                   // 0x0059(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Q0KY[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_ADDL[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (PADDING)
	};
