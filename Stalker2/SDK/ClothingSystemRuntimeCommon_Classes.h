...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_0DIY[0x4];                                   // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_ZOE5[0x20];                                  // 0x0148(0x0020) MISSED OFFSET (PADDING)
