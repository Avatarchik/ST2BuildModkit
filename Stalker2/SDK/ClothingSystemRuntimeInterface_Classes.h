...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_ZKAQ[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_OEJZ[0x18];                                  // 0x0078(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_T07T[0x50];                                  // 0x0090(0x0050) MISSED OFFSET (PADDING)
