...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_RZ4Z[0x68];                                  // 0x0028(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DFG6[0x180];                                 // 0x00B0(0x0180) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_VQME[0x48];                                  // 0x0028(0x0048) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_EBWC[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FADC[0x10];                                  // 0x00B0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              pad_DOOPGSCILG[0x01];                                    // 0x00B7(0x0001) PRE-DEFINED PROPERTY
		...
		unsigned char                                              pad_SY0O9523II[0x02];                                    // 0x00BE(0x0002) PRE-DEFINED PROPERTY
		...
		unsigned char                                              pad_XO6C8U69KA[0x04];                                    // 0x00D4(0x0004) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_JV9R[0x10];                                  // 0x00E0(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_JEQA[0x80];                                  // 0x0230(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_O940[0xB8];                                  // 0x0028(0x00B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_IBR0[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_OY1X[0x1B8];                                 // 0x0230(0x01B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PTH6[0xC8];                                  // 0x0028(0x00C8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_OZDI[0x1B8];                                 // 0x00E0(0x01B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_UB1T[0xA0];                                  // 0x0028(0x00A0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DSKU[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_GLE5[0x40];                                  // 0x0030(0x0040) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_A104[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_CEL3[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_5X5Y[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_MJMC[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_HCYH[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_E7Q4[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_JE15[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_1XDC[0x28];                                  // 0x0070(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NI92[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_MNY5[0x20];                                  // 0x0070(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_SDVU[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_3TI2[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_VH13[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
