...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_5XFO[0x3];                                   // 0x002D(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_8ZY8[0x1];                                   // 0x002F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_16X3[0x3];                                   // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QV4E[0x7];                                   // 0x0059(0x0007) MISSED OFFSET (PADDING)
