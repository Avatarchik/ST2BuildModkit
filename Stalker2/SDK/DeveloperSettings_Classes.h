...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_QL4N[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ZP0Y[0x18];                                  // 0x0028(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_V4EF[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
