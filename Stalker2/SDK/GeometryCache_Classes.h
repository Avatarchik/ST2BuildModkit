...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_WIVQ[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8498[0x10];                                  // 0x0050(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		class UGeometryCacheComponent*                             GeometryCacheComponent;                                  // 0x0280(0x0008) Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate
	...
	public:
		...
		unsigned char                                              UnknownData_IDAH[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_A3PE[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0090 (FullSize[0x0600] - InheritedSize[0x0570])
	 */
	class UGeometryCacheComponent : public UMeshComponent
	{
	public:
		class UGeometryCache*                                      GeometryCache;                                           // 0x0570(0x0008) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_4HE6[0x1];                                   // 0x057B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		int32_t                                                    NumTracks;                                               // 0x0588(0x0004) Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
		float                                                      CurrentAnimTime;                                         // 0x058C(0x0004) Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
		unsigned char                                              UnknownData_XDET[0x4C];                                  // 0x0590(0x004C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0X07[0x2];                                   // 0x05E2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RX21[0xC];                                   // 0x05F4(0x000C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_HWQP[0x2C];                                  // 0x002C(0x002C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_EATW[0x24];                                  // 0x005C(0x0024) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9E4R[0x68];                                  // 0x0060(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MJMM[0xC];                                   // 0x00CC(0x000C) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_211F[0xC8];                                  // 0x0058(0x00C8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_GE6U[0xC8];                                  // 0x0058(0x00C8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_74UP[0x3];                                   // 0x00E1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZHZX[0x3];                                   // 0x0355(0x0003) MISSED OFFSET (PADDING)
