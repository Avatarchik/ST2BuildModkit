...
namespace CG
{
	 ...
	 * 		Flags  -> (Final, Native, Public, BlueprintCallable)
	 * Parameters:
	 * 		float                                              NewStartTimeOffset                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	 ...
	 * Function:
	 * 		RVA    -> 0x01487F50
	 * 		Name   -> Function GeometryCache.GeometryCacheComponent.SetDuration
	 * 		Flags  -> (Final, Native, Public, BlueprintCallable)
	 * Parameters:
	 ...
	 */
	void UGeometryCacheComponent::SetDuration(float NewDuration)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function GeometryCache.GeometryCacheComponent.SetDuration");
		
		UGeometryCacheComponent_SetDuration_Params params {};
