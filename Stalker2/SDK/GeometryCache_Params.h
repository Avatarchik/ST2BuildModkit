...
namespace CG
{
	...
	{
	public:
		float                                                      NewStartTimeOffset;                                      // 0x0000(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	};
	...
	/**
	 * Function GeometryCache.GeometryCacheComponent.SetDuration
	 */
	struct UGeometryCacheComponent_SetDuration_Params
	{
	public:
