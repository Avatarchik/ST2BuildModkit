...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_ZIPY[0xC0];                                  // 0x0000(0x00C0) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_MFHK[0xC];                                   // 0x0000(0x000C) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_1FPR[0x9];                                   // 0x0000(0x0009) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_AUD0[0xC8];                                  // 0x0000(0x00C8) MISSED OFFSET (PADDING)
	};
