...
namespace CG
{
	 ...
	 * Size -> 0x00E8 (FullSize[0x0630] - InheritedSize[0x0548])
	 */
	class UMotionControllerComponent : public UPrimitiveComponent
	{
	public:
		unsigned char                                              UnknownData_IHH7[0x8];                                   // 0x0548(0x0008) Fix Super Size
		...
		bool                                                       bDisableLowLatencyUpdate : 1;                            // 0x0558(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_O2CF[0x3];                                   // 0x0559(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SUP1[0x2];                                   // 0x055E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UStaticMesh*                                         CustomDisplayMesh;                                       // 0x0568(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		TArray<class UMaterialInterface*>                          DisplayMeshMaterialOverrides;                            // 0x0570(0x0010) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_A5VJ[0x98];                                  // 0x0580(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TJ1C[0x10];                                  // 0x0620(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5JL9[0x8];                                   // 0x0050(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
