...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_X24C[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1JPR[0x46];                                  // 0x001A(0x0046) MISSED OFFSET (PADDING)
	};
