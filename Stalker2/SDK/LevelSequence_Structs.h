...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_HBFU[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		struct FGuid                                               GSCQuestGuid;                                            // 0x0038(0x0010) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
	};
	...
	public:
		...
		unsigned char                                              UnknownData_XHCU[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_UZIQ[0x3];                                   // 0x002D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_RI7D[0x4];                                   // 0x00A4(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_8DBZ[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_0DIA[0x20];                                  // 0x0000(0x0020) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_CNT7[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
