...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_6LT3[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7H8I[0x6];                                   // 0x002A(0x0006) MISSED OFFSET (PADDING)
	};
