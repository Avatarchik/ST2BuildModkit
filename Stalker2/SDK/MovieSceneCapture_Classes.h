...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_VSS1[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_03KL[0x7];                                   // 0x0051(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VUJ0[0x28];                                  // 0x0068(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_YWUH[0x3];                                   // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Y1QX[0x7];                                   // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GHA9[0x7];                                   // 0x0091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ERAU[0x20];                                  // 0x00A0(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_A9JW[0x10];                                  // 0x0058(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_QVZO[0x70];                                  // 0x0068(0x0070) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_X3B2[0x4];                                   // 0x00DC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MB45[0xE];                                   // 0x00DA(0x000E) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_L8NC[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_42ML[0x6];                                   // 0x00EA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_G8YI[0x118];                                 // 0x0110(0x0118) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_737Q[0xB];                                   // 0x0229(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HIAX[0x4];                                   // 0x0244(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_LRAP[0x78];                                  // 0x0060(0x0078) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GORP[0x2];                                   // 0x00DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_CUVP[0x3];                                   // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4ZTZ[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
