...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UGSCMovieSceneActor.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UGSCMovieSceneActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class MovieScene.GSCMovieSceneActor");
		return ptr;
	}
