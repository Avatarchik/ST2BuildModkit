...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_0IJ3[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3EGH[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_S97H[0x10];                                  // 0x0078(0x0010) MISSED OFFSET (PADDING)
