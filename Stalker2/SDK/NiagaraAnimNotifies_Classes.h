...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_5T9O[0x7];                                   // 0x0071(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_G5UX[0x3];                                   // 0x0079(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2HG2[0x4];                                   // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_U7T7[0x50];                                  // 0x0098(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GE5O[0x37];                                  // 0x0089(0x0037) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J8AS[0x3];                                   // 0x00C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WS11[0x4];                                   // 0x00CC(0x0004) MISSED OFFSET (PADDING)
