...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_H6JJ[0x48];                                  // 0x0058(0x0048) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3YS2[0x28];                                  // 0x0058(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WYQJ[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
