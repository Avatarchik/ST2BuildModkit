...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_O5S6[0x5];                                   // 0x0033(0x0005) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_E4GF[0x4];                                   // 0x0044(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ZFB4[0x2];                                   // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FHAY[0x2];                                   // 0x003A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LIS8[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_S63W[0x1F];                                  // 0x0061(0x001F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2ZI2[0x2];                                   // 0x0056(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_AGL4[0x2];                                   // 0x005E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PJCY[0x2];                                   // 0x0076(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FChaosSolverConfiguration                           SolverOptions;                                           // 0x0078(0x006C) Edit, Config, NoDestructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_5G3D[0x4];                                   // 0x00E4(0x0004) MISSED OFFSET (PADDING)
