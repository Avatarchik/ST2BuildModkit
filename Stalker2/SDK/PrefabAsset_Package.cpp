...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ATickOnlyInEditorActor.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* ATickOnlyInEditorActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class PrefabAsset.TickOnlyInEditorActor");
		return ptr;
	}
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction APrefabRelativePositionCustomPrimitiveDataUpdatingActor.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* APrefabRelativePositionCustomPrimitiveDataUpdatingActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class PrefabAsset.PrefabRelativePositionCustomPrimitiveDataUpdatingActor");
		return ptr;
	}
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ATerraVolume.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* ATerraVolume::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class PrefabAsset.TerraVolume");
		return ptr;
	}
