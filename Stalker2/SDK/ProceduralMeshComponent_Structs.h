...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_ZD39[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_2B1U[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_EUS9[0x6];                                   // 0x005A(0x0006) MISSED OFFSET (PADDING)
	};
