...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_0SOE[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NX58[0x70];                                  // 0x0280(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UMaterial*                                           Material;                                                // 0x02F0(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate
		class UResonanceAudioSpatializationSourceSettings*         Settings;                                                // 0x02F8(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate
	...
	{
	public:
		unsigned char                                              UnknownData_ZDAT[0x98];                                  // 0x0068(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_8I7W[0x7];                                   // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_WNA7[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VQ95[0x3];                                   // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6331[0x3];                                   // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9ZJL[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (PADDING)
