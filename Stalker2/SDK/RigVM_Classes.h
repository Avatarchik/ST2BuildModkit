...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UISC[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRigVMByteCode                                      ByteCodeStorage;                                         // 0x0060(0x0030) NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_GDXR[0x8];                                   // 0x0090(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRigVMInstructionArray                              Instructions;                                            // 0x0098(0x0010) Transient, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_WLD8[0x8];                                   // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_B0GX[0x4];                                   // 0x0174(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class FName>                                        FunctionNamesStorage;                                    // 0x0178(0x0010) ZeroConstructor, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_C5IA[0x20];                                  // 0x0188(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WUY8[0x98];                                  // 0x0208(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GPTW[0x18];                                  // 0x02A8(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ZS1R[0x38];                                  // 0x0230(0x0038) MISSED OFFSET (PADDING)
