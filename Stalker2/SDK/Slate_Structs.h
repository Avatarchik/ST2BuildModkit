...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_BNK0[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_0AF3[0x3];                                   // 0x0001(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	};
	...
	public:
		ECustomizedToolMenuVisibility                              Visibility;                                              // 0x0000(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_TY6U[0x3];                                   // 0x0001(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	};
	...
	public:
		...
		unsigned char                                              UnknownData_VOZR[0xE8];                                  // 0x0108(0x00E8) MISSED OFFSET (PADDING)
	};
