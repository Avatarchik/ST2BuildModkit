...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_1N1R[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_JXIO[0x3];                                   // 0x0025(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
