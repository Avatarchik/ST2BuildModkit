...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_4B26[0x18];                                  // 0x0030(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VDRD[0x27];                                  // 0x0031(0x0027) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3AS6[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
