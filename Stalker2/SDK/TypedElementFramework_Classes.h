...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_VHZS[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_MI88[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_900G[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_MS9L[0x920];                                 // 0x0028(0x0920) MISSED OFFSET (PADDING)
