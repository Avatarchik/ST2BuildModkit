...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_TWJW[0x800];                                 // 0x0028(0x0800) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_A8J0[0x50];                                  // 0x0848(0x0050) MISSED OFFSET (PADDING)
