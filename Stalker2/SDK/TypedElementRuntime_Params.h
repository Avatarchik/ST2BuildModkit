...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_YF1R[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_QNA3[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_624U[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FScriptTypedElementHandle                           ReturnValue;                                             // 0x0010(0x0008)  (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_KRGA[0x6];                                   // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_055T[0x6];                                   // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
